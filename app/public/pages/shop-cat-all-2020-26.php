...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>ASK Design | Art Portfolio - Shop Cat All - 2020 to 2026</title>
  </head>
...
<main>
  <div class="container-xxl">
    <section class="page-title-lead">   
          <h2 class="page-title">Shop - Original Art - Cat 2020-26</h2>
...
<!-- end of row -->
    ...
    <h5>
      <a href="shop-cat-all-2012-19.php"><button type="button" class="btn btn-outline-primary">MORE ART</button></a>
    </h5>
