...
<!-- End Google Tag Manager -->
    ...
    <title>ASK Design | Licensed Art</title>
  </head>
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown"><a class="nav-link active dropdown-toggle" href="portgd-rec.php" data-bs-toggle="dropdown" aria-expanded="false">Portfolio</a>
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item active" aria-current="page" href="">Licensed</a></li>
                </ul>
        </li>
...
<main>
  <div class="container-xxl">
    ...
    <section class="page-title-lead">   
          <h2 class="page-title">Portfolio - Licensed Art</h2>
          <h3 class="page lead subhd">Licensed Art Work</h3>
          <p class="page lead">Several of my pieces have been licensed for use. Please inquire if you are interested in licensing my work.</p>
    ...
    <div class="col-12"><!-- columns -->
      ...
      <div class="col-sm-4 mb-4 gallery-item graphic-design">
  	    <a href="../gallery/images/portgd-arch/013009thoreau.png" class="" data-toggle="lightbox" data-gallery="design"  data-size="xl" data-caption="ART DIRECTION, GRAPHIC DESIGN, &amp; ART - The Thoreau Society: <br>Kids' Tees sold at Shop at Walden Pond. Reproductions on sale: https://www.askdesign.biz/ask_shop/shop-cat.php">
